...
public class Q80_OnlineBook {
/*Online Book Merchants offers premium customers 1 free book with every purchase of 5 or more books and offers 2 
 * free books with every purchase of 8 or more books. It offers regular customers 1 free book with every purchase of 7 or more books, 
 * and offers 2 free books with every purchase of 12 or more books. 
     ...
     of the boolean variable isPremiumCustomer and the int variable nbooksPurchased. Print amount of freeBooks into the console. 
 */
	public static void main(String[] args) {
		    ...
		    if (isPremiumCustomer == true) {
		    	if (nbooksPurchased>=5 && nbooksPurchased<8) {
		    		...
		    		freeBooks = freeBooks+2 *(nbooksPurchased/8);
		    	...
		    	if (nbooksPurchased>=7 && nbooksPurchased<12) {
		    		...
		    		freeBooks = freeBooks+2*(nbooksPurchased/12);	
		    	}
